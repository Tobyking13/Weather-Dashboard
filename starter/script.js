...
var queryURL = ("https://api.openweathermap.org/data/2.5/weather?id=" + cityInfo.cityId + "&appid=" + weatehrAPIKey);
...
function cityData(info) {

    console.log(this.cityInfo.cityName)
